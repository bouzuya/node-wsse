...
UsernameToken = (function() {
  ...
  UsernameToken.prototype.getWSSEHeader = function(arg) {
    ...
    return 'UsernameToken ' + ["Username=\"" + (this.getUsername()) + "\"", "PasswordDigest=\"" + (this.getPasswordDigest()) + "\"", "Nonce=\"" + (nonceBase64 ? this._base64(this.getNonce()) : this.getNonce()) + "\"", "Created=\"" + (this.getCreated()) + "\""].join(', ');
  };
